"""
Django settings for myGoalTracker project.
...
SECRET_KEY = 'uw9@5+yzob=+&74zf))%n=lq+cd-&@c(hsgw@f(1pg)h0+o6-w'
...
ROOT_URLCONF = 'myGoalTracker.urls'
...
WSGI_APPLICATION = 'myGoalTracker.wsgi.application'
